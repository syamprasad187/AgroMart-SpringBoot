...
<body class="bg-gradient-to-r from-red-400 via-orange-400 via-yellow-400 via-green-400 via-blue-400 to-purple-400 font-sans min-h-screen flex flex-col">
  ...
  <div class="flex-grow flex items-start justify-center mt-16">  
    <div id="login-card" class="w-full max-w-sm bg-white rounded-lg shadow-lg p-6 space-y-4 transform transition-all duration-500">
        <h3 class="text-center text-xl font-semibold text-gray-700 underline">Customer Login</h3>
        
        <form method="post" action="checkcustomerlogin" class="space-y-4">
            <div>
                <label for="cemail" class="block text-gray-600">Enter Email ID</label>
                <input type="email" id="cemail" name="cemail" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400" required />
            </div>
            <div>
                <label for="cpwd" class="block text-gray-600">Enter Password</label>
                <input type="password" id="cpwd" name="cpwd" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400" required />
            </div>
